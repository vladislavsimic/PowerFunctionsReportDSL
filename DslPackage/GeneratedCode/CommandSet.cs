...
namespace SchneiderElectricDMS.PowerFunctionsReportDSL
{
	...
	/// </summary>
	internal partial class PowerFunctionsReportDSLCommandSet : PowerFunctionsReportDSLCommandSetBase
	{
		/// <summary>
		/// Constructs a new PowerFunctionsReportDSLCommandSet.
		/// </summary>
		public PowerFunctionsReportDSLCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PowerFunctionsReportDSLCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PowerFunctionsReportDSLCommandSetBase.
		/// </summary>
		protected PowerFunctionsReportDSLCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewPowerFunctionsReportDSLExplorerCommand,
				typeof(PowerFunctionsReportDSLEditorFactory).GUID);
		...
		{
			PowerFunctionsReportDSLExplorerToolWindow explorer = this.PowerFunctionsReportDSLExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected PowerFunctionsReportDSLDocData CurrentPowerFunctionsReportDSLDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PowerFunctionsReportDSLDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PowerFunctionsReportDSLDocView CurrentPowerFunctionsReportDSLDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PowerFunctionsReportDSLDocView;
			}
		}
		...
		/// </summary>
		protected PowerFunctionsReportDSLExplorerToolWindow PowerFunctionsReportDSLExplorerToolWindow
		{
			get
			{
				PowerFunctionsReportDSLExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(PowerFunctionsReportDSLExplorerToolWindow), true) as PowerFunctionsReportDSLExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				PowerFunctionsReportDSLExplorerToolWindow explorerWindow = this.PowerFunctionsReportDSLExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PowerFunctionsReportDSLClipboardCommandSet : PowerFunctionsReportDSLClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PowerFunctionsReportDSLClipboardCommandSet.
		/// </summary>
		public PowerFunctionsReportDSLClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PowerFunctionsReportDSLClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PowerFunctionsReportDSLClipboardCommandSetBase.
		/// </summary>
		protected PowerFunctionsReportDSLClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
