...
namespace SchneiderElectricDMS.PowerFunctionsReportDSL
{
	...
	/// </remarks>
	public partial class PowerFunctionsReportDSLHelpKeywordHelper : PowerFunctionsReportDSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PowerFunctionsReportDSLHelpKeywordHelper.
		/// </summary>
		protected PowerFunctionsReportDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PowerFunctionsReportDSLHelpKeywordHelper.
		/// </summary>
		public static PowerFunctionsReportDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PowerFunctionsReportDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PowerFunctionsReportDSLHelpKeywordHelperBase.
		/// </summary>
		protected PowerFunctionsReportDSLHelpKeywordHelperBase()
			: base() { }
